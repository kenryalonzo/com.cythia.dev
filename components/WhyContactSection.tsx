...
const reasons = [
	...
	},
	{
		icon: (
			<svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
				<path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zM3.75 20.105V4.875A2.625 2.625 0 016.375 2.25h11.25A2.625 2.625 0 0120.25 4.875v10.5A2.625 2.625 0 0117.625 18H6.375a2.625 2.625 0 01-2.625-2.625z" />
			</svg>
		),
					...
					{reasons.map((reason, i) => (
						<Reveal key={reason.title} delay={i * 0.08}>
							<motion.div
								...
								style={{
									boxShadow: "0 1px 3px rgba(9,52,133,0.04), 0 4px 12px rgba(9,52,133,0.03)",
								}}
							>
