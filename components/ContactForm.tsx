...
export function ContactSection() {
	...
	return (
		<section className="relative overflow-hidden bg-ivory py-16 md:py-24">
			...
			{/* ─── Lotus central ─── */}
			<div className="pointer-events-none absolute left-1/2 top-[55%] z-20 hidden -translate-x-1/2 -translate-y-1/2 lg:flex lg:h-[110px] lg:w-[110px] lg:items-center lg:justify-center lg:rounded-full lg:border lg:border-gold-deep/20 lg:bg-ivory/80 lg:shadow-soft lg:backdrop-blur-sm">
			...
			{/* ─── Contenu ─── */}
			<div className="container-luxe relative z-10 mx-auto grid max-w-[1100px] grid-cols-1 items-start gap-16 lg:grid-cols-2 lg:gap-24">
							...
							<form onSubmit={handleSubmit} className="mt-8 space-y-4">
								<div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
									<input
										...
										className="w-full rounded-xl border border-slate-line/40 bg-white/70 px-5 py-3.5 font-sans text-[15px] text-royal placeholder:text-slate-ink/40 transition-all focus:border-gold focus:bg-white focus:outline-none focus:ring-2 focus:ring-gold/20"
									/>
									<input
										name="phone"
										type="tel"
								...
								<div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
									...
									<div className="relative">
										<select
											name="service"
											required
											className="w-full appearance-none rounded-xl border border-slate-line/40 bg-white/70 px-5 py-3.5 pr-10 font-sans text-[15px] text-slate-ink/60 transition-all focus:border-gold focus:bg-white focus:outline-none focus:ring-2 focus:ring-gold/20"
										>
								...
								<textarea
									...
									className="w-full resize-none rounded-xl border border-slate-line/40 bg-white/70 px-5 py-3.5 font-sans text-[15px] text-royal placeholder:text-slate-ink/40 transition-all focus:border-gold focus:bg-white focus:outline-none focus:ring-2 focus:ring-gold/20"
								/>
								...
								<motion.button
									...
									whileTap={{ scale: 0.98 }}
									className="group relative flex w-full items-center justify-between overflow-hidden rounded-full bg-gradient-to-r from-gold-warm via-gold to-gold-warm px-2 py-2 pl-8 font-sans text-[13px] font-bold uppercase tracking-[0.1em] text-royal shadow-[0_4px_14px_rgba(201,162,39,0.25)] transition-all hover:shadow-lift"
								>
									<span className="flex-1 text-center">Envoyer le message</span>
									<span className="flex h-[42px] w-[42px] shrink-0 items-center justify-center rounded-full bg-royal text-gold transition-transform duration-300 group-hover:scale-105 group-hover:bg-royal-light">
				...
				<Reveal direction="right">
					<div className="w-full pt-2 lg:pl-10">
						<span className="eyebrow inline-flex items-center gap-2">
							Nos coordonnées
						</span>
							...
							<div className="flex items-start gap-5">
								...
								<div className="pt-0.5">
									...
									<div className="mt-2.5 flex gap-3">
										<a href={site.instagram} target="_blank" rel="noopener noreferrer" className="flex h-8 w-8 items-center justify-center rounded-full bg-ivory text-royal shadow-sm ring-1 ring-slate-line/30 transition-all hover:bg-royal hover:text-gold hover:ring-royal" aria-label="Instagram">
										...
										<a href={site.facebook} target="_blank" rel="noopener noreferrer" className="flex h-8 w-8 items-center justify-center rounded-full bg-ivory text-royal shadow-sm ring-1 ring-slate-line/30 transition-all hover:bg-royal hover:text-gold hover:ring-royal" aria-label="Facebook">
										...
										<a href={site.tiktok} target="_blank" rel="noopener noreferrer" className="flex h-8 w-8 items-center justify-center rounded-full bg-ivory text-royal shadow-sm ring-1 ring-slate-line/30 transition-all hover:bg-royal hover:text-gold hover:ring-royal" aria-label="TikTok">
