...
export function FAQ() {
	...
	return (
		<section className="relative overflow-hidden bg-ivory py-10 md:py-14">
			<div className="container-luxe">
				<div className="grid grid-cols-1 items-start gap-8 lg:grid-cols-[1fr_1.2fr]">
					...
					<Reveal direction="right">
						<div className="relative flex min-h-[300px] items-center justify-center overflow-hidden py-10 lg:min-h-[360px]">
