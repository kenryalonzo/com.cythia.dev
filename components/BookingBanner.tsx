  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        {[...Array(16)].map((_, i) => {
          const lefts = [
            22, 35, 48, 58, 65, 72, 78, 84, 88, 91, 94, 96, 40, 55, 70, 82,
          ];
          const tops = [
            18, 60, 30, 72, 14, 48, 22, 68, 38, 75, 50, 28, 82, 8, 58, 42,
          ];
          const sizes = [
            1, 1, 1.5, 1, 1, 1, 1.5, 1, 1, 1, 1.5, 1, 1, 1, 1, 1.5,
          ];
          return (
            <motion.div
              key={i}
        ...
        <div className="relative flex items-center py-10 sm:min-h-[200px] lg:min-h-[260px]">
          ...
          >
            {[
              ...
              { size: 220, dur: 2.8, delay: 0.5, opacity: 0.3 },
            ...
            <div
              style={{
                ...
                overflow: "hidden",
                maskImage:
                  "linear-gradient(to bottom, rgba(0,0,0,0.15) 0%, transparent 90%)",
                WebkitMaskImage:
                  "linear-gradient(to bottom, rgba(0,0,0,0.15) 0%, transparent 90%)",
              }}
            >
          ...
          <div className="container-luxe relative mx-auto flex w-full flex-col items-center gap-4 px-4 sm:flex-row sm:items-center sm:gap-8 sm:px-6 lg:pl-[260px]">
            ...
            >
              <motion.a
                href={waLink(
                  "Bonjour, je souhaite prendre rendez-vous en ligne.",
                )}
                target="_blank"
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #FDCF02 0%, #e8b800 100%)",
                  whiteSpace: "nowrap",
                }}
              >
